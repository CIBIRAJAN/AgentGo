  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () => UrlLauncherHelper.openUrl(upload.fileUrl),
          borderRadius: BorderRadius.circular(16),
          child: Container(
                ...
                if ((upload.status == 'uploaded' || upload.status == 'failed') &&
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(widget.isProcessing ? 'Processing...' : 'Process Now – Extract Dues'),
                ...
                if (upload.status == 'completed' && upload.dueMonth != null) ...[
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: Text(_isGenerating ? 'Generating...' : 'Download Modified PDF (with Phone Numbers)'),
