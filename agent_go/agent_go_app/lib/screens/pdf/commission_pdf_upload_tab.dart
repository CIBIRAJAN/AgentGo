...
class CommissionPdfUploadTab extends ConsumerStatefulWidget {
  const CommissionPdfUploadTab({super.key});

  @override
  ConsumerState<CommissionPdfUploadTab> createState() => _CommissionPdfUploadTabState();
}

class _CommissionPdfUploadTabState extends ConsumerState<CommissionPdfUploadTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: fileUrl != null ? () => UrlLauncherHelper.openUrl(fileUrl) : null,
          borderRadius: BorderRadius.circular(14),
          child: Container(
