  ...
  bool _isBlocked() {
    ...
    if (user != null && user.isWalletBlocked) {
      UpgradeDialog.show(
        ...
        message: 'Your Premium Wallet payment has failed. Please navigate to Subscriptions and clear your negative balance to unlock your app features.',
      );
      return true;
    }
    return false;
  ...
  void _openPdfUpload() {
    ...
    if (ref.read(userProvider.notifier).isBasePlan) {
      UpgradeDialog.show(
        ...
        message: 'PDF upload and extraction requires a Mid or Premium plan.',
      );
      return;
    }
  ...
  void _openAnalytics() {
    ...
    if (ref.read(userProvider.notifier).isBasePlan) {
      UpgradeDialog.show(
        context: context,
        title: 'Premium Feature',
        message: 'Analytics and insights require a Mid or Premium plan.',
      );
      return;
    }
    Navigator.of(context).push(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        elevation: 8,
        height: 70, // Increased to fix overflow
