...
class GlobalCelebrationsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GlobalCelebrationsScreen> createState() =>
      _GlobalCelebrationsScreenState();
}

class _GlobalCelebrationsScreenState
    extends ConsumerState<GlobalCelebrationsScreen> {
          ...
          children: [
            ...
            ListTile(
              leading: Container(
                ...
                child:
                    const Icon(Icons.translate_rounded, color: Colors.orange),
              ),
  ...
  void _generateLocalizedPoster(GlobalCelebration celebration, String lang) {
    ...
    if (lang == 'ta') {
      ...
      if (name.contains('new year')) {
        ...
        festiveMessage =
            'இந்த ஆண்டு உங்கள் வாழ்வில் மகிழ்ச்சியும் வெற்றியும் பெருகட்டும்.';
        ...
        festiveMessage =
            'இந்தியாவின் சுதந்திர தினத்தை பெருமையுடன் கொண்டாடுவோம்!';
      } else if (name.contains('shivaratri')) {
        title = 'மஹா சிவராத்திரி நல்வாழ்த்துக்கள்';
        festiveMessage =
            'எம்பெருமான் ஈசனின் அருள் உங்களுக்கு எப்போதும் கிடைக்கட்டும்.';
      ...
      if (name.contains('new year'))
        festiveMessage =
            'May this year bring you new joy, success, and prosperity!';
      else if (name.contains('pongal'))
        festiveMessage =
            'Wishing you a harvest of happiness and abundant prosperity!';
      else if (name.contains('republic'))
        festiveMessage = 'Saluting the spirit of India. Happy Republic Day!';
      else if (name.contains('independence'))
        festiveMessage =
            'Freedom in mind, Faith in words. Happy Independence Day!';
      else if (name.contains('shivaratri'))
        festiveMessage = 'May the divine grace of Lord Shiva be with you always.';
      else if (name.contains('holi'))
        festiveMessage =
            'May your life be as vibrant and colorful as the festival itself!';
      else if (name.contains('diwali'))
        festiveMessage =
            'Wishing you a festival of lights filled with joy and prosperity!';
      else if (name.contains('christmas'))
        festiveMessage =
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        if (image != null) {
                          ...
                          final imagePath =
                              await File('${directory.path}/greeting.png').create();
                          await imagePath.writeAsBytes(image);
                          await Share.shareXFiles([XFile(imagePath.path)],
                              text:
                                  'Happy ${celebration.name}! - Shared via AgentGo');
                        }
                      },
                      style: ElevatedButton.styleFrom(
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            const Text('No festive days found',
                                style:
                                    TextStyle(color: AppColors.textSecondary)),
                            TextButton(
                                onPressed: _fetchCelebrations,
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            onPressed: () =>
                                                _generateAndShowPoster(
                                                    celebration),
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: Colors.white,
                                              foregroundColor:
                                                  celebration.themeColor,
                                              shape: RoundedRectangleBorder(
                                                  borderRadius:
