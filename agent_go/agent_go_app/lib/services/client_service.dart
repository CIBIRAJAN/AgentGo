...
class ClientService {
  ...
  /// Fetch count of clients with birthdays or anniversaries today
  Future<int> getTodayCelebrationsCount() async {
    try {
      final response = await _client.rpc(
        'get_upcoming_celebrations',
        params: {'p_user_ids': _targetUserIds, 'p_days': 0},
      );
      return (response as List).length;
    } catch (e) {
      print('Error fetching celebrations count: $e');
      return 0;
    }
  }
}
